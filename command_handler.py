...
class CommandHandler:
    ...
    def handle_local(
        ...
        *,
        ...
        if self._matches_email_action(raw_text=user_input, text=text):
            return CommandResult(True, EMAIL_UNCONFIGURED_RESPONSE, focus_text="Email delivery is not configured.")
    ...
    def _matches_email_action(self, *, raw_text: str, text: str) -> bool:
